...
#include <windows.h>
#undef nk_F_CONTEXT
typedef void (* nk_F_CONTEXT)(struct nk_context*);
...
NK_API struct nk_context * nk_gdi_create_ctx(LPCWSTR title, int width, int height, HINSTANCE hInstance);
NK_API void nk_gdi_end_ctx(struct nk_context *ctx);
NK_API void nk_gdi_event_loop(struct nk_context *ctx, nk_F_CONTEXT fGUI);
